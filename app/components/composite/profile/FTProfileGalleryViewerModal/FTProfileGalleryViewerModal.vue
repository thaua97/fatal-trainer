  ...
  >
    ...
    >
      ...
      <FTIconButton
        ...
        size="md"
        variant="neutral"
        class="absolute inset-s-[max(0.75rem,env(safe-area-inset-left))] top-1/2 z-10 -translate-y-1/2 border-white/20! bg-white/10! text-white! shadow-none backdrop-blur-sm hover:bg-white/20!"
      ...
      <FTIconButton
        ...
        size="md"
        variant="neutral"
        class="absolute inset-e-[max(0.75rem,env(safe-area-inset-right))] top-1/2 z-10 -translate-y-1/2 border-white/20! bg-white/10! text-white! shadow-none backdrop-blur-sm hover:bg-white/20!"
